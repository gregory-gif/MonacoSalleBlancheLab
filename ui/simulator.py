...
def show_simulator():
    ...
    def render_analysis(stats, config, start_ga, overrides, all_results):
        ...
        with report_container:
            ...
            # Progression mapping
            press_map = {0: 'Flat', 1: 'Press 1-Win', 2: 'Press 2-Wins', 3: 'Progression 100-150-250', 4: "Capped D'Alembert (Strategist)", 5: "La Caroline (1-1-2-3-4)", 6: "Negative Caroline (1-1-2-3-4)", 7: "Negatif 1-2-4-7 Snap-Back", 8: "The Gentle Surgeon (1-2-4)", 9: "Winner's Guard (1-1-2-4)"}
